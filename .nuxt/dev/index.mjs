...
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/louka/Documents/Nuxt-TheLibrary-Louka/node_modules/vue-bundle-renderer/dist/runtime.mjs';
...
import { hash } from 'file://C:/Users/louka/Documents/Nuxt-TheLibrary-Louka/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file://C:/Users/louka/Documents/Nuxt-TheLibrary-Louka/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Users/louka/Documents/Nuxt-TheLibrary-Louka/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://C:/Users/louka/Documents/Nuxt-TheLibrary-Louka/node_modules/unenv/runtime/fetch/index.mjs';
...
import { consola } from 'file://C:/Users/louka/Documents/Nuxt-TheLibrary-Louka/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://C:/Users/louka/Documents/Nuxt-TheLibrary-Louka/node_modules/unctx/dist/index.mjs';
import { isVNode, version, unref } from 'file://C:/Users/louka/Documents/Nuxt-TheLibrary-Louka/node_modules/vue/index.mjs';
...
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://C:/Users/louka/Documents/Nuxt-TheLibrary-Louka/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/louka/Documents/Nuxt-TheLibrary-Louka/node_modules/@unhead/shared/dist/index.mjs';
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\louka\\Documents\\Nuxt-TheLibrary-Louka","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\louka\\Documents\\Nuxt-TheLibrary-Louka\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\louka\\Documents\\Nuxt-TheLibrary-Louka\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\louka\\Documents\\Nuxt-TheLibrary-Louka\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\louka\\Documents\\Nuxt-TheLibrary-Louka\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _OjoMo3J3kY = (function(nitro) {
...
const _69FGqSdLtx = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _J97Vlj = lazyEventHandler(() => {
...
const _lazy_98FxiD = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_98FxiD, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _J97Vlj, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_98FxiD, lazy: true, middleware: false, method: undefined }
];
